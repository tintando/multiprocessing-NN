...
X, y = make_regression(n_samples=500000, n_features=100, n_informative=100, noise=0.1, random_state=42)
...
df = pd.DataFrame(X_standardized, columns=[f'Feature_{i}' for i in range(1, 101)])
...
df.to_csv('florida.csv', index=False, header=False)
